...
export const STR = {
  ...
  nav_orbit: { ru: "Мой мир", en: "My World" },
  ...
  premium: { ru: "NECTAR Premium", en: "NECTAR Premium" },
  ...
  sub_meds: { ru: "Библиотека практик", en: "Practice library" },
  sub_meds_desc: { ru: "Полная библиотека медитаций + новые практики каждый месяц", en: "Full library of meditations + new practices every month" },
  sub_orbit: { ru: "Мой мир (Орбита)", en: "My World (Orbit)" },
  sub_orbit_desc: { ru: "8 медитативных сценариев — тревога, сила, любовь, женственность и другие состояния", en: "8 meditative scenarios — anxiety, power, love, femininity and other states" },
  sub_journal: { ru: "Дневник с ИИ", en: "AI journal" },
  sub_journal_desc: { ru: "Безлимитные записи + анализ паттернов от ИИ", en: "Unlimited entries + AI pattern analysis" },
  sub_navigator: { ru: "Что меня беспокоит", en: "What's bothering me" },
  sub_navigator_desc: { ru: "Подбирает нужную медитацию под вашу ситуацию — отношения, тревогу, деньги, рост, самоценность", en: "Matches the right meditation to your situation — relationships, anxiety, money, growth, self-worth" },
  sub_capital: { ru: "Психологический капитал", en: "Psychological capital" },
  sub_capital_desc: { ru: "Трекинг внутреннего роста по 5 параметрам — безопасность, самоценность, женственность, доверие, подлинность", en: "Inner growth tracking across 5 axes — safety, self-worth, femininity, trust, authenticity" },
  sub_coach: { ru: "ИИ-коуч", en: "AI coach" },
  sub_coach_desc: { ru: "Чат с ИИ-коучем — разберите любую ситуацию или внутренний запрос и получите точечную рекомендацию", en: "Chat with your AI coach — work through any situation or inner question and get a precise recommendation" },
  sub_insights: { ru: "Еженедельный разбор", en: "Weekly breakdown" },
  sub_insights_desc: { ru: "Еженедельный анализ вашего прогресса от ИИ — динамика капитала и рекомендации", en: "Weekly AI analysis of your progress — capital dynamics and recommendations" },
  sub_tracker: { ru: "Трекер практик", en: "Practice tracker" },
  sub_tracker_desc: { ru: "Серия дней · статистика медитаций · достижения", en: "Daily streak · meditation stats · achievements" },
