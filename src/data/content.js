...
export const SECTIONS = [
  {
    id: "resource", title: "Ресурс и восстановление", color: "#e39a3c", meds: [
  ...
  {
    id: "feminine", title: "Женское состояние", color: "#DCD2EC", meds: [
  ...
  {
    id: "receiving", title: "Реализация и получение благ", color: "#F3CE72", meds: [
      { n: 10, title: "Получение благ от мира", dur: "19 мин", free: false, short: "Открытие способности принимать хорошее.", long: "Переводит женщину в состояние, где хорошее перестаёт быть чем-то чужим или неудобным. Помогает начать открываться навстречу жизни — принимать любовь, поддержку, радость без чувства вины и страха." },
  ...
  {
    id: "newlevel", title: "Новый уровень", color: "#8E76B8", meds: [
  ...
  {
    id: "self", title: "Подлинность и самоценность", color: "#C9AFA6", meds: [
...
export const SITUATIONS = [
  { title: "Сложности в отношениях", desc: "Чувствую дистанцию, теряю себя", recs: ["Состояние женской притягательности", "Женская энергия", "Восполнение женской ресурсности"] },
  ...
  { title: "Не чувствую себя женщиной", desc: "Потеряна связь с женственностью", recs: ["Женская энергия", "Состояние женской притягательности", "Восполнение женской ресурсности"] },
...
export const RECOMMENDATIONS = {
  ...
  quiet: [
    ...
    { t: "Женское внутреннее расслабление", s: "12 мин · Бесплатно", free: true, sec: "resource" },
    { t: "Женская энергия", s: "20 мин · Женское", free: false, sec: "feminine" },
  ],
  full: [
...
export const PERSONAL_CONTENT = {
  ...
  "Хочу раскрыть свою женственность и притяжение": {
    ...
    p: ["Женская энергия", "Состояние женской притягательности", "Восполнение женской ресурсности"],
  },
};
